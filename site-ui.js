...
(function () {
  ...
  if (!document.querySelector('.wa-sticky')) {
    ...
    wa.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
  ...
  /* ═══════════════════════════════════════════════════════
     3. INSTAGRAM STICKY BUTTON
  ═══════════════════════════════════════════════════════ */
  if (!document.querySelector('.ig-sticky')) {
    const ig = document.createElement('a');
    ig.href = 'https://www.instagram.com/bahadurtours_travels/';
    ig.className = 'ig-sticky';
    ig.target = '_blank';
    ig.rel = 'noopener noreferrer';
    ig.setAttribute('aria-label', 'Follow us on Instagram');
    ig.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="currentColor">
